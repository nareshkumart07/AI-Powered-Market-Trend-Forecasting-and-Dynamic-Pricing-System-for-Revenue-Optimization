...
# This class defines the structure of the GRU model.
...
def run_gru_forecasting_pipeline(
    ...
    """
    Runs a complete time-series forecasting pipeline for a specific product using a GRU model.
    ...
    Args:
        ...
        model_params (Dict): Hyperparameters for the GRU model.
    ...
    print(f"1. Key Sales Drivers: The strongest predictors are recent performance ('lag_1_day', 'rolling_mean_7_days').")
    print("   > INSIGHT: This product has strong sales momentum. Ensure inventory is replenished quickly after a sales spike.")
    ...
    print(f"\n3. Model Performance: The GRU model forecasts sales with a Mean Absolute Error (MAE) of {mae:.2f} units.")
    print(f"   > INSIGHT: On average, the forecast is off by approximately {mae:.0f} units per day. Use this to set safety stock levels.")
